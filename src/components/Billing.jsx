   ...
   <section id="product" className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo} >
            ...
            <p className ={`${styles.paragraph} max-w-[470px] mt-5 `}>
                hey heyesbjd jsjsjdhhs jsdnsjsdsj sjndsndjhsd
                 bjshdjhdsjs jsdjdhudhgd ndhsdhhdshdjhsd djsd
                 sjshdhdshd sdshdhdhsjh sdbsdjhs sbdjshjdhsd
                 kjshdnsdhudh dnjhsdhsudhm njdshdhsdh sjdjshd
                 hsdhsdj kskjhshdjshd sjdjhsdjshd hdsjdhjshd
            </p>
